 ...
 *
 * Update an #IplImage internally after being copied.  Fixes the
 ...
 *
 * Return a pointer to a registered #IplImage that has been made
 ...
 *
 * Construct and return an #IplImage of the same format as the reference
 ...
 *
 * Construct an #IplImage suitable for sending over the given named pad.
 ...
 *
 * Build a #uint64_t representing the collection of formats given as arguments,
 ...
 *
 * Construct a set of #GstCaps representing the union of all the types in the given
 * format list.
 *
 ...
 *
 * Construct a format list containing all the types listed in the given caps.
 *
